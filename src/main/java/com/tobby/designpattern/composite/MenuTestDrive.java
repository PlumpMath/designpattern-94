...
public class MenuTestDrive {
	...
	public static void main(String[] args) {
		...
		pancakeHouseMenu.add(new MenuItem("K&B's Pancake Breakfast", "Pancakes with scrambled eggs, and toast", false, 2.99));
		...
		dinnerMenu.add(new MenuItem("Pasta", "Spaghetti with Marinara Sauce, and a slice of sourdough break", true, 3.89));
		...
		dessertMenu.add(new MenuItem("CheeseCake(v)", "Creamy New York cheesecake, with a chocolate graham crust", true, 1.99));
		dessertMenu.add(new MenuItem("Sorbet(v)", "a scoop of raspberry and a scoop of lime", false, 1.89));
